...
import comfyuiAddonRoute from "./routes/addon-comfyui";
import comfyuiAgentRoute from "./routes/agent-comfyui";
import parserAddonRoute from "./routes/addon-parser";
import producerAddonRoute from "./routes/addon-producer";
import guardAddonRoute from "./routes/addon-guard";
...
app.route("/api/addons/comfyui", comfyuiAddonRoute);
app.route("/api/agents/comfyui", comfyuiAgentRoute);
app.route("/api/addons/parser", parserAddonRoute);
app.route("/api/addons/producer", producerAddonRoute);
app.route("/api/addons/guard", guardAddonRoute);
