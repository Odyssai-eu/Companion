...
// Session cookie Secure flag — resolved via the shared helper so auth.ts and
// setup.ts can't drift, and so COOKIE_SECURE=false/true is honoured (not just
// 0/1). Full rationale in server/lib/cookie-secure.ts.
